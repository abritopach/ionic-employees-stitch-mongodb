...
export class OrganizationChartComponent implements OnInit {
  ...
  organization: any = {
    ...
    'departments': [
      {'name': 'Marketing', 'class': 'dep-a', 'children': [
      ...
      {'name': 'Technical', 'class': 'dep-b', 'children': [
      ...
      {'name': 'Sales', 'class': 'dep-d', 'children': [
      ...
      {'name': 'Finance', 'class': 'dep-e', 'children': [
